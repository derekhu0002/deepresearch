...
graph TD
    subgraph 技术栈
        A1[噪声/分形<br/>FastNoiseLite 3.5k★] --> A2[约束求解<br/>WFC 25.3k★ / MarkovJunior 8.2k★]
        A2 --> A3[AI 驱动<br/>LLM Agent / 扩散模型]
    end
    subgraph 产品形态
        C1[Roguelike/地牢<br/>Caves of Qud] --> C2[开放世界/沙盒<br/>Veloren 7.5k★ / Cubyz 3.6k★]
        C2 --> C3[AI 原生生成<br/>修仙世界模拟器 2k★]
    end
    A1 --> C2
    A2 --> C1
    A2 --> C2
